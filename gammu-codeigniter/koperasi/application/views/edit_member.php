                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h4>Edit Data Nasabah</h4>   
                            ...
                            <form method="GET" data-toggle="validator" role="form" action="<?php echo base_url().'admin/update_member/';?>">
                                <div class="form-group">
                                  <label for="inputKursus">Nama</label>  
                                  <div class="input-group">
                                    <input type="text" class="form-control" name="inputNama" id="inputNama" value="<?php echo $data['nama'];?>" required>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="date" class="form-control" name="bday" id="inputBrithday" value="<?php echo $data['tgl_lahir'];?>" required>
                                    <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
                                  </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputKursus">Alamat</label>
                                  <div class="input-group">
                                    <input type="text" class="form-control" name="inputAlamat" id="inputAlamat" value="<?php echo $data['alamat'];?>" required>
                                    <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
                                  </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputKursus">No Telp</label>
                                  <div class="input-group" data-validate="phone">
                                    <input type="text" class="form-control" name="inputTelp" id="inputTelp" value="<?php echo $data['no_telp'];?>" required>
                                    <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="input-group" data-validate="number">
                                    <input type="text" class="form-control" name="inputSaldo" id="inputTelp" value="<?php echo $data['saldo'];?>" required>
                                    <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
                                  </div>
                                </div>
                                <div class="form-group">
                                <input style="display: none" name="hidden-id" value="<?php echo $data['id']; ?>">     
