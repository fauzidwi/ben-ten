        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-fw fa-send"></i>  Send SMS</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="container">   
                            <div class="row">
                                <div class="col-sm-10">
                                   <form method="post" action="<?php echo base_url().'admin/reply';?>" data-toggle="validator" role="form">
                                        <div class="form-group">
                                          <label for="inputKursus">Nomor Tujuan</label>
                                          <div class="input-group">
                                                        <select class="form-control" name="NoTujuan" required>
                                                            <option value="">NO_TELP - NO_REK</option>
                                                            <?php foreach ($data as $key) { ?>
                                                            <option value="<?php echo $key['no_telp'];?>"><?php echo $key['no_telp'];?>  -  <?php echo $key['id'];?></option>
                                                            <?php } ?>
                                                        </select>
