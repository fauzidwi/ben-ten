                                   ...
                                   <form method="post" action="<?php echo base_url().'admin/reply';?>" data-toggle="validator" role="form">
                                        <div class="form-group">
                                          <div class="input-group">
                                             <input type="hidden" name="NoTujuan" value="<?php echo $result;?>">          
                                          </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="validate-length">Pesan</label>
                                            <div class="input-group" data-validate="length" data-length="160">
                                                <textarea type="text" class="form-control" name="pesan" id="pesan" placeholder="160 karakter" required></textarea>
