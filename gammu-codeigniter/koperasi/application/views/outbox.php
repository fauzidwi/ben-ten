        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-fw fa-folder-open-o"></i>  Outbox</a>
                    </li>
                    <li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">                                    
                            <table id="myTable" class="table table-bordred table-striped">
                                ...
                                <td><?php $date=date_create($key['SendingDateTime']);echo date_format($date, 'jS F Y'); ?></td>
                                <td><p><a href="<?php echo base_url().'admin/delete_outbox/'.$key['ID'];?>" class="btn btn-danger btn-xs" data-placement="top" data-toggle="tooltip" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a></p></td>
                                </tr>  
                                <?php }?>        
                                </tbody>      
                            </table>
